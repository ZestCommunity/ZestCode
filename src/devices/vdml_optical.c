...
#define RAW_ERR_INIT {.clear = PROS_ERR, .red = PROS_ERR, .green = PROS_ERR, .blue = PROS_ERR}
...
#define GESTURE_ERR_INIT                                                                           \
    {.udata = OPT_GESTURE_ERR,                                                                     \
     .ddata = OPT_GESTURE_ERR,                                                                     \
     .ldata = OPT_GESTURE_ERR,                                                                     \
     .rdata = OPT_GESTURE_ERR,                                                                     \
     .type = OPT_GESTURE_ERR,                                                                      \
     .pad = OPT_GESTURE_ERR,                                                                       \
     .count = OPT_COUNT_ERR,                                                                       \
     .time = OPT_TIME_ERR}
