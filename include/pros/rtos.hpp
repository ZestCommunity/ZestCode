...
class Task {
  ...
  public:
    ...
    static task_t create(
        ...
        return pros::c::task_create([](void* parameters) {
     ...
     *
     * void initialize() {
     *   pros::Task my_task(my_task_fn, pros::TASK_PRIORITY_DEFAULT, TASK_STACK_DEPTH_DEFAULT, "My
     * Task");
     * }
     * \endcode
     */
     ...
     */
    std::uint32_t
    notify_ext(std::uint32_t value, notify_action_e_t action, std::uint32_t* prev_value);
